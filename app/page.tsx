...
import { ArrowRight,  Recycle, Users, Coins, MapPin, Trash } from 'lucide-react'
...
function AnimatedGlobe() {
  return (
    <div className="relative w-32 h-32 mx-auto mb-8">
      ...
      <Trash className="absolute inset-0 m-auto h-16 w-16 text-green-600 animate-pulse" />
    </div>
  )
}
    ...
    <div className={`container mx-auto px-4 py-16 ${poppins.className}`}>
      <section className="text-center mb-20">
        ...
        <h1 className="text-6xl font-bold mb-6 text-gray-800 tracking-tight">
          Scrap the Scrapers <span className="text-green-600">Waste Management</span>
        </h1>
      ...
      <section className="bg-white p-10 rounded-3xl shadow-lg mb-20">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <ImpactCard title="CO2 Offset" value={`${impactData.co2Offset} kg`} icon={Trash} />
        </div>
      </section>
