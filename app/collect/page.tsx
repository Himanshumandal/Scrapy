...
export default function CollectPage() {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      try {
        // Check if the cleaned response text is valid JSON
        ...
        toast.error('Error parsing the response. Please try again.')
        setVerificationStatus('failure')
      }
    } catch (error) {
      console.error('Error verifying waste:', error)
      toast.error('Error verifying waste. Please try again.')
      setVerificationStatus('failure')
    }
  }
